<%@ Page Title="Интернет-магазин PuzzleStore" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Default.aspx.cs" Inherits="cursovaya._Default" %>
...
<asp:Content ID="BodyContent"  ContentPlaceHolderID="MainContent" runat="server">
	...
	<div style="display: flex;
            ...
            <asp:Button ID="search" runat="server" Text="Найти" Height="35px" OnClick="search_Click1" />
            </form>
	</div>
	<div style="display:flex">
		...
		<div style="max-width:1066px;min-height:700px">
			<h3 style="font-size:2.5em;margin:20px; font-weight: bold"><a style="text-decoration: none; color:black" href="\Default.aspx">Каталог</a></h3>
              <%
                  if (searched != false)
                      Response.Write(String.Format(@"<h3 style='margin-left:20px'>Результаты поиска: '{0}'</h3>", searchquery));
              %>
				...
				<%
                    foreach (cursovaya.Puzzle puzzle in db.Puzzle)
                    {
                        ...
                        if (searched == true)
                        {
                            ...
                            if (containedstring.Contains(searchquery))
